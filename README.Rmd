...
Use the `get_best_snp_per_MB` function to extract the top/lead SNPs from the crohns dataset. Then include them in the manhattan call function using the `variants` argument.
