...
Load the `gwas_CD` dataset, which is a subset of GWAS results on Crohn´s from the UK biobank.
...
To label the lead SNPs on the manhattan plot, first use the get_best_snp_per_MB to extract them from the crohns dataset. Then include them in the manhattan call function with the variants arguments.
