...
*topr's* two main plot functions are <code>manhattan()</code> and <code>regionplot()</code>. See <a href="https://totajuliusd.github.io/topr_manual/">topr plot functions</a> for more details on all of *topr's* plot functions.
